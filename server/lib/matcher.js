...
const KEYWORDS = [
  ...
  // 移动端
  'android', 'ios', 'flutter', 'react native', 'swift', 'kotlin', '移动端', 'app 开发',
  // 工程 / 部署
  'git', 'docker', 'linux', 'nginx', '全栈', 'api', 'http', '部署', '架构', '微服务',
  // 测试 / 运维
  '测试', '自动化测试', '单元测试', '集成测试', 'pytest', 'jest', 'vitest', 'playwright', 'selenium',
  'e2e', 'ci/cd', '运维', '监控', '性能测试', '接口测试',
  // 数据 / 爬虫
  '爬虫', '数据采集', '数据分析', 'pandas', '数据可视化', '数据回收', '数据仓库', 'etl', '数据开发',
  // AI / 算法
  'ai', 'llm', '大模型', 'rag', '检索增强', 'prompt', 'embedding', '向量', 'deepseek', '智谱',
  'agent', '智能体', '机器学习', '深度学习', '算法', 'nlp', '自然语言处理', '计算机视觉', '推荐系统', '风控',
  // 嵌入式 / 硬件
  '嵌入式', '单片机', 'stm32', 'rtos', 'c语言', 'c++', '硬件', '物联网', 'fpga',
  // 设计
  'ui', 'ux', '视觉设计', '交互设计', '平面设计', '插画', 'figma', 'sketch', 'photoshop', '动效', '品牌设计',
  // 产品
  '产品经理', '需求分析', '原型', 'axure', 'prd', '用户研究',
  // 市场 / 品牌 / 广告
  '市场', '品牌', '广告', '投放', '营销', '增长', 'seo', 'sem', '私域', '转化', '渠道',
  // 游戏
  '游戏策划', '游戏运营', '游戏开发', 'unity', 'unreal', 'ue', '数值策划', '游戏',
  // 安全
  '网络安全', '渗透测试', '安全',
  // 职能 / 通用
  '财务', '会计', '审计', '税务', '出纳', '人力资源', '招聘', '绩效', '薪酬', '培训', '法务', '合规', '行政',
  '客服', '销售', '咨询', '项目管理',
  // 内容 / 办公
  'office', 'excel', 'ppt', '文案', '剪辑', '摄影', '短视频',
  // 二次元 / 达人运营
  '二次元', 'acg', 'acgn', '动画', '漫画', 'vtuber', '手办', '同人', 'coser',
  '达人运营', '内容运营', '新媒体', '小红书', '抖音', 'b站', 'bilibili', '微博', '快手',
  '涨粉', '选题', '爆款', '粉丝', '直播', '用户运营', '社群运营', '电商运营', '活动运营',
]
